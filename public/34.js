...
/***/ "./resources/js/components/src/containers/Admin/Curricullum/List.js":
/*!**************************************************************************!*\
  !*** ./resources/js/components/src/containers/Admin/Curricullum/List.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
var CurricullumList = function CurricullumList() {
    ...
    columns: [{
      ...
      render: function render(rowData) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_4__["default"], {
          variant: "inherit"
        }, moment__WEBPACK_IMPORTED_MODULE_12___default()(rowData.created_at).format("DD-MM-YYYY"));
      }
    }, {
      title: "Updated At",
      field: "updated_at",
      render: function render(rowData) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_4__["default"], {
          variant: "inherit"
        }, moment__WEBPACK_IMPORTED_MODULE_12___default()(rowData.updated_at).format("DD-MM-YYYY"));
      }
    }],
    data: data,
...
/* harmony default export */ __webpack_exports__["default"] = (CurricullumList);
